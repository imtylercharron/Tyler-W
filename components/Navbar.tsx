    ...
    <>
      <nav className={`${s.navbar} ${scrolled ? s.scrolled : ''}`}>
        ...
        <div className={`${s.navLinks} ${mobileMenuOpen ? s.open : ''}`}>
          ...
          <a href="#" className={s.navLink} onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); closeMenu(); }}>Home</a>
          ...
          <a href="mailto:imtylercharron@gmail.com" className={`${s.navLink} ${s.mobileOnly}`} onClick={closeMenu}>Contact Me</a>
        </div>
        
        <div className={s.rightSection}>
          <a href="mailto:imtylercharron@gmail.com" className={s.contactBtn}>Contact Me</a>
